    ...
    template: {
      ...
      spec: {
        ...
        initContainers: [{
          ...
          command: ["git"],
          args: ["clone", "https://github.com/SocialGouv/carnet-de-bord.git", "/mnt/carnet-de-bord"],
          volumeMounts: [{
            name: "restore-db-volume",
        ...
        containers: [{
          ...
          command: ["sh", "-c"],
          args: ["psql < /mnt/carnet-de-bord/hasura/seeds/carnet_de_bord/1627477977566_seed-data.sql"],
          envFrom: [{
            secretRef: {
