...
from cdb.api.db.crud.notebook import get_notebooks_by_structure_id
from cdb.api.db.crud.out import notebook_to_out
from cdb.api.db.models.notebook import Notebook
from cdb.api.db.models.out import NotebookOut
