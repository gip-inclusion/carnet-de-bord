...
from backend.api.db.crud.structure import get_structures
from backend.api.db.models.beneficiary import Beneficiary
from backend.api.db.models.external_data import ExternalSource
from backend.api.db.models.notebook import NotebookMember
...
@mock.patch(
    "backend.cdb_csv.pe.map_principal_row", side_effect=Exception("Parsing exception")
)
