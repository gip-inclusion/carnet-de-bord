...
@pytest.fixture
def get_vincent_timaitre_admin_structure_id() -> UUID:
    return UUID("c2a346cd-b3dd-4892-a33d-7ada82654f97")
...
@pytest.fixture
def laure_loge_account_id() -> UUID:
    return UUID("f29ca78a-4719-4658-8d19-48d3df9178b5")
