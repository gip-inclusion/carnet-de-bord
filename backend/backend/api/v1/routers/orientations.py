...
from backend.api._gen.schema_gql import schema
from backend.api.core.emails import Member, Person, send_notebook_member_email
from backend.api.core.settings import settings
from backend.api.db.crud.beneficiary_structure import (
    get_deactivate_beneficiary_structure_mutation,
    get_insert_beneficiary_structure_mutation,
)
from backend.api.db.crud.notebook_info import get_insert_notebook_info_mutation
from backend.api.db.crud.notebook_member import (
...
from backend.api.db.crud.orientation_info import get_orientation_info
from backend.api.db.crud.orientation_request import (
    get_accept_orientation_request_mutation,
)
from backend.api.db.models.member_type import MemberTypeEnum
from backend.api.db.models.orientation_info import OrientationInfo
