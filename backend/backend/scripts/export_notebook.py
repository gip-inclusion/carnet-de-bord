...
from backend.api.db.crud.notebook import get_notebooks_by_structure_id
from backend.api.db.crud.out import notebook_to_out
from backend.api.db.models.notebook import Notebook
from backend.api.db.models.out import NotebookOut
