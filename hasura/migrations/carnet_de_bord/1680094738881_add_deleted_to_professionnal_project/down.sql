...
alter table "public"."professional_project" drop constraint "professional_project_deleted_by_fkey";
...
alter table "public"."professional_project" drop column "deleted_by";
alter table "public"."professional_project" drop column "deleted_at";
