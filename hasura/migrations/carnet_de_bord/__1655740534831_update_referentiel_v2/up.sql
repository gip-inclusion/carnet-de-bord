...
-- update migrations
--
UPDATE public.ref_situation SET description = 'Difficulté à accéder à un justificatif d''identité' WHERE theme='difficulte_administrative' AND description='Sans papiers d’identités, titre de séjour…', 'difficulte_administrative');
UPDATE public.ref_situation SET description = 'Difficulté à accéder à son avis d’imposition' WHERE theme='difficulte_administrative' AND description='Sans avis d’imposition', 'difficulte_administrative');
UPDATE public.ref_situation SET description = 'Sécurité sociale à mettre à jour' WHERE theme='difficulte_administrative' AND description='Pas de sécurité sociale à jour', 'difficulte_administrative');
UPDATE public.ref_situation SET description = 'Ressources précaires' WHERE theme='difficulte_financiere' AND description='Ressources précaires ou ponctuelles', 'difficulte_financiere');
UPDATE public.ref_situation SET description = 'Besoin d''un soutien alimentaire' WHERE theme='difficulte_financiere' AND description='Rupture alimentaire', 'difficulte_financiere');
UPDATE public.ref_situation SET description = 'Indisponible pour un emploi dans l''immédiat' WHERE theme='emploi' AND description='Prêt mais pas pour n''importe quel emploi', 'emploi');
UPDATE public.ref_situation SET description = 'Indisponible pour un emploi dans l''immédiat' WHERE theme='emploi' AND description='Pas prêt pour un emploi', 'emploi');
UPDATE public.ref_situation SET description = 'Indisponible pour un emploi dans l''immédiat' WHERE theme='emploi' AND description='Ne sais pas s''il est prêt pour un emploi', 'emploi');
UPDATE public.ref_situation SET description = 'Prêt à suivre une formation' WHERE theme='formation' AND description='Prêt pour une formation', 'formation');
UPDATE public.ref_situation SET description = 'Ne souhaite pas suivre une formation' WHERE theme='formation' AND description='Ne sais pas s''il est prêt', 'formation');
UPDATE public.ref_situation SET description = 'Habitat mobile' WHERE theme='logement' AND description='Logement de fortune (caravane, mobile home...)', 'logement');
UPDATE public.ref_situation SET description = 'Territoire rural isolé' WHERE theme='logement' AND description='Eloigné de tout', 'logement');
UPDATE public.ref_situation SET description = 'Accès ou utilisation difficile des outils numériques' WHERE theme='maitrise_langue' AND description='Illectronisme', 'maitrise_langue');
UPDATE public.ref_situation SET description = 'Couverture sociale à mettre à jour' WHERE theme='sante' AND description='Absence de couverture / complémentaire sociale santé ( CSS, PUMa… )', 'sante');

--
-- delete migrations
--
DELETE public.ref_situation WHERE theme='difficulte_administrative' AND description='Autonome mais nécessitant d''être guidé dans le cadre d''un accès aux droits', 'difficulte_administrative');
DELETE public.ref_situation WHERE theme='difficulte_financiere' AND description='Incidents budgétaires ponctuels', 'difficulte_financiere');
DELETE public.ref_situation WHERE theme='difficulte_financiere' AND description='Inadéquation charges / ressources', 'difficulte_financiere');
DELETE public.ref_situation WHERE theme='emploi' AND description='En projet de profession libérale', 'emploi');
DELETE public.ref_situation WHERE theme='formation' AND description='Prêt à en parler', 'formation');
DELETE public.ref_situation WHERE theme='logement' AND description='Autre', 'logement');
