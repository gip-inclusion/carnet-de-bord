...
WITH rcid as (SELECT public.rome_codes.id FROM public.rome_codes WHERE label = 'Aide à domicile (K1304)') INSERT INTO public.wanted_job (rome_code_id, notebook_id) VALUES (rcid, '9b07a45e-2c7c-4f92-ae6b-bc2f5a3c9a7d');
...
WITH rcid as (SELECT public.rome_codes.id FROM public.rome_codes WHERE label = 'Aide à domicile (K1304)') INSERT INTO public.wanted_job (rome_code_id, notebook_id) VALUES (rcid, 'b7e43c7c-7c3e-464b-80de-f4926d4bb1e0');
