...
module CdbGQL.Object.Orientation_type_min_fields exposing (..)
...
id : SelectionSet (Maybe String) CdbGQL.Object.Orientation_type_min_fields
id =
    Object.selectionForField "(Maybe String)" "id" [] (Decode.string |> Decode.nullable)


label : SelectionSet (Maybe String) CdbGQL.Object.Orientation_type_min_fields
label =
