...
module CdbGQL.Object.Rsa_closure_reason_max_fields exposing (..)
...
code : SelectionSet (Maybe String) CdbGQL.Object.Rsa_closure_reason_max_fields
code =
    Object.selectionForField "(Maybe String)" "code" [] (Decode.string |> Decode.nullable)


label : SelectionSet (Maybe String) CdbGQL.Object.Rsa_closure_reason_max_fields
label =
