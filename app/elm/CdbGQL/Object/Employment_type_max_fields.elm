...
module CdbGQL.Object.Employment_type_max_fields exposing (..)
...
id : SelectionSet (Maybe String) CdbGQL.Object.Employment_type_max_fields
id =
    Object.selectionForField "(Maybe String)" "id" [] (Decode.string |> Decode.nullable)


label : SelectionSet (Maybe String) CdbGQL.Object.Employment_type_max_fields
label =
