...
module CdbGQL.Object.Professional_min_fields exposing (..)
...
createdAt : SelectionSet (Maybe CdbGQL.ScalarCodecs.Timestamptz) CdbGQL.Object.Professional_min_fields
createdAt =
...
email : SelectionSet (Maybe CdbGQL.ScalarCodecs.Citext) CdbGQL.Object.Professional_min_fields
email =
...
firstname : SelectionSet (Maybe String) CdbGQL.Object.Professional_min_fields
firstname =
    Object.selectionForField "(Maybe String)" "firstname" [] (Decode.string |> Decode.nullable)


id : SelectionSet (Maybe CdbGQL.ScalarCodecs.Uuid) CdbGQL.Object.Professional_min_fields
id =
...
lastname : SelectionSet (Maybe String) CdbGQL.Object.Professional_min_fields
lastname =
    Object.selectionForField "(Maybe String)" "lastname" [] (Decode.string |> Decode.nullable)


mobileNumber : SelectionSet (Maybe String) CdbGQL.Object.Professional_min_fields
mobileNumber =
    Object.selectionForField "(Maybe String)" "mobileNumber" [] (Decode.string |> Decode.nullable)


position : SelectionSet (Maybe String) CdbGQL.Object.Professional_min_fields
position =
    Object.selectionForField "(Maybe String)" "position" [] (Decode.string |> Decode.nullable)


structureId : SelectionSet (Maybe CdbGQL.ScalarCodecs.Uuid) CdbGQL.Object.Professional_min_fields
structureId =
...
updatedAt : SelectionSet (Maybe CdbGQL.ScalarCodecs.Timestamptz) CdbGQL.Object.Professional_min_fields
updatedAt =
