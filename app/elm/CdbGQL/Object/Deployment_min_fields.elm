...
module CdbGQL.Object.Deployment_min_fields exposing (..)
...
createdAt : SelectionSet (Maybe CdbGQL.ScalarCodecs.Timestamptz) CdbGQL.Object.Deployment_min_fields
createdAt =
...
departmentCode : SelectionSet (Maybe String) CdbGQL.Object.Deployment_min_fields
departmentCode =
    Object.selectionForField "(Maybe String)" "departmentCode" [] (Decode.string |> Decode.nullable)


id : SelectionSet (Maybe CdbGQL.ScalarCodecs.Uuid) CdbGQL.Object.Deployment_min_fields
id =
...
label : SelectionSet (Maybe String) CdbGQL.Object.Deployment_min_fields
label =
    Object.selectionForField "(Maybe String)" "label" [] (Decode.string |> Decode.nullable)


updatedAt : SelectionSet (Maybe CdbGQL.ScalarCodecs.Timestamptz) CdbGQL.Object.Deployment_min_fields
updatedAt =
