...
module CdbGQL.Object.Notebook_event_type_max_fields exposing (..)
...
comment : SelectionSet (Maybe String) CdbGQL.Object.Notebook_event_type_max_fields
comment =
    Object.selectionForField "(Maybe String)" "comment" [] (Decode.string |> Decode.nullable)


value : SelectionSet (Maybe String) CdbGQL.Object.Notebook_event_type_max_fields
value =
