...
module CdbGQL.Object.Professional_project_aggregate_fields exposing (..)
...
avg :
    SelectionSet decodesTo CdbGQL.Object.Professional_project_avg_fields
    -> SelectionSet (Maybe decodesTo) CdbGQL.Object.Professional_project_aggregate_fields
avg object____ =
    Object.selectionForCompositeField "avg" [] object____ (Basics.identity >> Decode.nullable)


type alias CountOptionalArguments =
    { columns : OptionalArgument (List CdbGQL.Enum.Professional_project_select_column.Professional_project_select_column)
...
count :
    ...
    -> SelectionSet Int CdbGQL.Object.Professional_project_aggregate_fields
count fillInOptionals____ =
    let
        ...
        optionalArgs____ =
            [ Argument.optional "columns" filledInOptionals____.columns (Encode.enum CdbGQL.Enum.Professional_project_select_column.toString |> Encode.list), Argument.optional "distinct" filledInOptionals____.distinct Encode.bool ]
...
max :
    SelectionSet decodesTo CdbGQL.Object.Professional_project_max_fields
    -> SelectionSet (Maybe decodesTo) CdbGQL.Object.Professional_project_aggregate_fields
max object____ =
...
min :
    SelectionSet decodesTo CdbGQL.Object.Professional_project_min_fields
    -> SelectionSet (Maybe decodesTo) CdbGQL.Object.Professional_project_aggregate_fields
min object____ =
...
stddev :
    SelectionSet decodesTo CdbGQL.Object.Professional_project_stddev_fields
    -> SelectionSet (Maybe decodesTo) CdbGQL.Object.Professional_project_aggregate_fields
stddev object____ =
...
stddev_pop :
    SelectionSet decodesTo CdbGQL.Object.Professional_project_stddev_pop_fields
    -> SelectionSet (Maybe decodesTo) CdbGQL.Object.Professional_project_aggregate_fields
...
stddev_samp :
    SelectionSet decodesTo CdbGQL.Object.Professional_project_stddev_samp_fields
    -> SelectionSet (Maybe decodesTo) CdbGQL.Object.Professional_project_aggregate_fields
...
sum :
    SelectionSet decodesTo CdbGQL.Object.Professional_project_sum_fields
    -> SelectionSet (Maybe decodesTo) CdbGQL.Object.Professional_project_aggregate_fields
sum object____ =
...
var_pop :
    SelectionSet decodesTo CdbGQL.Object.Professional_project_var_pop_fields
    -> SelectionSet (Maybe decodesTo) CdbGQL.Object.Professional_project_aggregate_fields
var_pop object____ =
...
var_samp :
    SelectionSet decodesTo CdbGQL.Object.Professional_project_var_samp_fields
    -> SelectionSet (Maybe decodesTo) CdbGQL.Object.Professional_project_aggregate_fields
var_samp object____ =
...
variance :
    SelectionSet decodesTo CdbGQL.Object.Professional_project_variance_fields
    -> SelectionSet (Maybe decodesTo) CdbGQL.Object.Professional_project_aggregate_fields
variance object____ =
