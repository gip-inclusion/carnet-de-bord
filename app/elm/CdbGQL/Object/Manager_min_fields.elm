...
module CdbGQL.Object.Manager_min_fields exposing (..)
...
createdAt : SelectionSet (Maybe CdbGQL.ScalarCodecs.Timestamptz) CdbGQL.Object.Manager_min_fields
createdAt =
...
deploymentId : SelectionSet (Maybe CdbGQL.ScalarCodecs.Uuid) CdbGQL.Object.Manager_min_fields
deploymentId =
...
email : SelectionSet (Maybe CdbGQL.ScalarCodecs.Citext) CdbGQL.Object.Manager_min_fields
email =
...
firstname : SelectionSet (Maybe String) CdbGQL.Object.Manager_min_fields
firstname =
    Object.selectionForField "(Maybe String)" "firstname" [] (Decode.string |> Decode.nullable)


id : SelectionSet (Maybe CdbGQL.ScalarCodecs.Uuid) CdbGQL.Object.Manager_min_fields
id =
...
lastname : SelectionSet (Maybe String) CdbGQL.Object.Manager_min_fields
lastname =
    Object.selectionForField "(Maybe String)" "lastname" [] (Decode.string |> Decode.nullable)


updatedAt : SelectionSet (Maybe CdbGQL.ScalarCodecs.Timestamptz) CdbGQL.Object.Manager_min_fields
updatedAt =
