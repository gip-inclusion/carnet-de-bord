...
module CdbGQL.Object.Ref_target_aggregate exposing (..)
...
aggregate :
    SelectionSet decodesTo CdbGQL.Object.Ref_target_aggregate_fields
    -> SelectionSet (Maybe decodesTo) CdbGQL.Object.Ref_target_aggregate
...
nodes :
    ...
    -> SelectionSet (List decodesTo) CdbGQL.Object.Ref_target_aggregate
nodes object____ =
