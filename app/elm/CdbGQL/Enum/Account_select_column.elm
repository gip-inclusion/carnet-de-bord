...
module CdbGQL.Enum.Account_select_column exposing (..)
...
list : List Account_select_column
list =
...
decoder : Decoder Account_select_column
decoder =
    Decode.string
        |> Decode.andThen
            (\string ->
                case string of
                    ...
                    _ ->
                        Decode.fail ("Invalid Account_select_column type, " ++ string ++ " try re-running the @dillonkearns/elm-graphql CLI ")
            )


{-| Convert from the union type representing the Enum to a string that the GraphQL server will recognize.
-}
toString : Account_select_column -> String
toString enum____ =
    case enum____ of
        AccessKey ->
            "accessKey"
...
-}
fromString : String -> Maybe Account_select_column
