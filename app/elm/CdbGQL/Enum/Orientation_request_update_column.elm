...
module CdbGQL.Enum.Orientation_request_update_column exposing (..)

import Json.Decode as Decode exposing (Decoder)


{-| update columns of table "orientation\_request"
...
-}
type Orientation_request_update_column
    = BeneficiaryId
    | CreatedAt
    | DecidedAt
...
list : List Orientation_request_update_column
list =
...
decoder : Decoder Orientation_request_update_column
decoder =
    Decode.string
        |> Decode.andThen
            (\string ->
                case string of
                    ...
                    _ ->
                        Decode.fail ("Invalid Orientation_request_update_column type, " ++ string ++ " try re-running the @dillonkearns/elm-graphql CLI ")
            )


{-| Convert from the union type representing the Enum to a string that the GraphQL server will recognize.
-}
toString : Orientation_request_update_column -> String
toString enum____ =
    case enum____ of
        BeneficiaryId ->
            "beneficiaryId"
...
-}
fromString : String -> Maybe Orientation_request_update_column
