...
module CdbGQL.Enum.Notebook_select_column exposing (..)
...
list : List Notebook_select_column
list =
...
decoder : Decoder Notebook_select_column
decoder =
    Decode.string
        |> Decode.andThen
            (\string ->
                case string of
                    ...
                    _ ->
                        Decode.fail ("Invalid Notebook_select_column type, " ++ string ++ " try re-running the @dillonkearns/elm-graphql CLI ")
            )


{-| Convert from the union type representing the Enum to a string that the GraphQL server will recognize.
-}
toString : Notebook_select_column -> String
toString enum____ =
    case enum____ of
        BeneficiaryId ->
            "beneficiaryId"
...
-}
fromString : String -> Maybe Notebook_select_column
