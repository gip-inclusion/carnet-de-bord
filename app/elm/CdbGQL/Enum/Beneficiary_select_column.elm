...
module CdbGQL.Enum.Beneficiary_select_column exposing (..)
...
-}
type Beneficiary_select_column
    = Address1
    | Address2
    | CafNumber
    | City
...
list : List Beneficiary_select_column
list =
...
decoder : Decoder Beneficiary_select_column
decoder =
    Decode.string
        |> Decode.andThen
            (\string ->
                case string of
                    ...
                    _ ->
                        Decode.fail ("Invalid Beneficiary_select_column type, " ++ string ++ " try re-running the @dillonkearns/elm-graphql CLI ")
            )


{-| Convert from the union type representing the Enum to a string that the GraphQL server will recognize.
-}
toString : Beneficiary_select_column -> String
toString enum____ =
    case enum____ of
        Address1 ->
            "address1"
...
-}
fromString : String -> Maybe Beneficiary_select_column
