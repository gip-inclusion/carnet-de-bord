...
module CdbGQL.Enum.Notebook_member_select_column exposing (..)

import Json.Decode as Decode exposing (Decoder)


{-| select columns of table "notebook\_member"
...
-}
type Notebook_member_select_column
    = AccountId
    | Active
    | CreatedAt
    | CreatorId
...
list : List Notebook_member_select_column
list =
...
decoder : Decoder Notebook_member_select_column
decoder =
    Decode.string
        |> Decode.andThen
            (\string ->
                case string of
                    ...
                    _ ->
                        Decode.fail ("Invalid Notebook_member_select_column type, " ++ string ++ " try re-running the @dillonkearns/elm-graphql CLI ")
            )


{-| Convert from the union type representing the Enum to a string that the GraphQL server will recognize.
-}
toString : Notebook_member_select_column -> String
toString enum____ =
    case enum____ of
        AccountId ->
            "accountId"
...
-}
fromString : String -> Maybe Notebook_member_select_column
