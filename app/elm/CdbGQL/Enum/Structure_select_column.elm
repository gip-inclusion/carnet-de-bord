...
module CdbGQL.Enum.Structure_select_column exposing (..)
        ...
        |> Decode.andThen
            (\string ->
                case string of
                    ...
                    _ ->
                        Decode.fail ("Invalid Structure_select_column type, " ++ string ++ " try re-running the @dillonkearns/elm-graphql CLI ")
            )


{-| Convert from the union type representing the Enum to a string that the GraphQL server will recognize.
-}
toString : Structure_select_column -> String
toString enum____ =
    case enum____ of
        Address1 ->
            "address1"
...
-}
fromString : String -> Maybe Structure_select_column
