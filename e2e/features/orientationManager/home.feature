...
Fonctionnalité: Accueil d'un chargé d'orientation
	...
	Scénario: Consultation des chiffres clefs
		...
		Alors je vois "7" dans la tuile "Bénéficiaires orientés" sous le titre "Mon portefeuille"
		Alors je vois "3" dans la tuile "Bénéficiaires à orienter" sous le titre "Mon portefeuille"
		Alors je vois "1" dans la tuile "Demandes de réorientation" sous le titre "Mon portefeuille"
		Alors je vois "38" dans la tuile "Bénéficiaires orientés" sous le titre "Autres bénéficiaires de mon territoire"
		Alors je vois "8" dans la tuile "Bénéficiaires à orienter" sous le titre "Autres bénéficiaires de mon territoire"
		Alors je vois "4" dans la tuile "Demandes de réorientaiton" sous le titre "Autres bénéficiaires de mon territoire"
