...
Scénario: Ajout d'un axe de travail
	...
	Alors je vois "Ajouter un axe de travail" dans le volet
...
Scénario: Ajout d'un objectif
	...
	Alors je vois "Prêt à suivre une formation" dans le volet
	Quand je clique sur "Ajouter un objectif"
	Alors je vois "Ajouter un objectif" dans le volet
