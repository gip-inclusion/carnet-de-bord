...
Scénario: Ajout de plusieurs projet pro
	...
	Quand je sélectionne l'option "Temps plein" dans la liste "Durée du temps de travail" après le texte "Développeur / Développeuse informatique (M1805)"
	Quand je sélectionne l'option "CDI" dans la liste "Type de contrat" après le texte "Développeur / Développeuse informatique (M1805)"
