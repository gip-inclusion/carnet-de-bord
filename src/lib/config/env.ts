...
export const AUTH_PRIVATE_KEY = import.meta.env.VITE_AUTH_PRIVATE_KEY;
export const AUTH_PRIVATE_KEY_FILE = import.meta.env.VITE_AUTH_PRIVATE_KEY_FILE;
export const AUTH_PUBLIC_KEY = import.meta.env.VITE_AUTH_PUBLIC_KEY;
export const AUTH_PUBLIC_KEY_FILE = import.meta.env.VITE_AUTH_PUBLIC_KEY_FILE;
