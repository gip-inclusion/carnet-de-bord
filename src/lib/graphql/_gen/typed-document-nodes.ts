...
export type GetBeneficiariesWithStructureQueryVariables = Exact<{
	offset?: Scalars['Int'];
	limit?: Scalars['Int'];
...
export type GetBeneficiariesWithStructureQuery = {
	__typename?: 'query_root';
...
export const GetBeneficiariesWithStructureDocument = {
	kind: 'Document',
	definitions: [
		{
			kind: 'OperationDefinition',
			operation: 'query',
			name: { kind: 'Name', value: 'GetBeneficiariesWithStructure' },
			variableDefinitions: [
				{
					kind: 'VariableDefinition',
	...
	GetBeneficiariesWithStructureQuery,
	GetBeneficiariesWithStructureQueryVariables
>;
...
>;
export type GetBeneficiariesWithStructureQueryStore = OperationStore<
	GetBeneficiariesWithStructureQuery,
	GetBeneficiariesWithStructureQueryVariables
>;
